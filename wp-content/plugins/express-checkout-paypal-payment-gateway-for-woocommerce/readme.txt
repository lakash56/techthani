...
Tags: PayPal, express checkout, PayPal standard, payment plugin, credit card, debit card, WooCommerce, cart page checkout, payment gateway, PayPal checkout
...
* [Fix] - Fixed issue in validating PayPal credentials
